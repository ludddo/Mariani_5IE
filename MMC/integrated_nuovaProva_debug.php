...
// Aggiungi una richiesta per inserire un paragrafo vuoto e successivamente il nuovo testo
$requests = [
    new Google\Service\Docs\Request([
        'insertText' => [
            ...
            'text' => "\n" // Inserisce un paragrafo vuoto all'inizio della cella
        ]
    ]),
    new Google\Service\Docs\Request([
        'insertText' => [
            'location' => [
                'index' => $cellIndexStart + 1,
            ],
